...
export class PropertyProcessorExceptionToRequestErrorMapperStrategy implements IExceptionToRequestErrorMapperStrategy {
    exceptionType(): string {
        return 'PropertyProcessorException';
    }
